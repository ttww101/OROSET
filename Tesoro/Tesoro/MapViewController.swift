...
class MapViewController: UIViewController {
    ...
    @IBOutlet weak var crownProgressView: UIView!
...
//            if userStatus.key
    ...
    func setupViewController() {
        ...
        //load map imageview
        mapImageView.image = #imageLiteral(resourceName: "treasue-map")
        mapImageView.frame = CGRect(x: 0, y: 0,
                                    width: ScrollMapView.frame.width * 1.5,
        ...
        //vibrate image view
        crownImageView.vibrate(amplitude: 10, duration: 0.5)
        ...
        for i in 0...4 {
            userProgressDotsStackView.subviews[i].layer.cornerRadius = userProgressDotsStackView.frame.height / 4
        ...
        for i in 0...4 {
            enemyProgressDotsStackView.subviews[i].layer.cornerRadius = enemyProgressDotsStackView.frame.height / 4
